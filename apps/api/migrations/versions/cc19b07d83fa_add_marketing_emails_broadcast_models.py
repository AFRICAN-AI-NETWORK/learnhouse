...
down_revision: Union[str, None] = '777ba59f2a02'
...
def upgrade() -> None:
    ...
    sa.Enum('MARKETING', 'ALL_OPTIONAL', name='unsubscribescope').create(op.get_bind())
    sa.Enum('PENDING', 'SENDING', 'SENT', 'FAILED_RETRYABLE', 'FAILED_PERMANENT', 'SKIPPED', 'UNSUBSCRIBED', name='campaignrecipientstatus').create(op.get_bind())
    sa.Enum('GENERAL', 'COURSE_MARKETING', name='campaigntype').create(op.get_bind())
