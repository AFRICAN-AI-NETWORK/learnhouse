...
def upgrade() -> None:
    ...
    if table_exists("activity", conn) and not column_exists(
        "activity", "published", conn
    ):
        op.add_column(
            "activity",
            sa.Column(
    ...
    if table_exists("activity", conn) and column_exists(
        "activity", "published_version", conn
    ):
    ...
    if table_exists("assignmentusersubmission", conn) and column_exists(
        "assignmentusersubmission", "assignment_user_uuid", conn
    ):
