...
def upgrade() -> None:
    ...
    chapteractivity_fks = [fk['name'] for fk in inspector.get_foreign_keys('chapteractivity')]
    ...
    collectioncourse_fks = [fk['name'] for fk in inspector.get_foreign_keys('collectioncourse')]
    ...
    coursechapter_fks = [fk['name'] for fk in inspector.get_foreign_keys('coursechapter')]
