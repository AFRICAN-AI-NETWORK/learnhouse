...
def upgrade() -> None:
    ...
    if not _table_exists("conversation"):
        op.create_table(
            ...
            sa.Column(
                "conversation_uuid", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            ...
            sa.ForeignKeyConstraint(
                ["archived_by_user_id"], ["user.id"], ondelete="SET NULL"
            ),
            sa.ForeignKeyConstraint(
                ["org_id"], ["organization.id"], ondelete="CASCADE"
            ),
            sa.ForeignKeyConstraint(
                ["participant_one_id"], ["user.id"], ondelete="CASCADE"
            ),
            sa.ForeignKeyConstraint(
                ["participant_two_id"], ["user.id"], ondelete="CASCADE"
            ),
    ...
    _create_index_if_not_exists(
        "ix_conversation_conversation_uuid",
        "conversation",
        ["conversation_uuid"],
        unique=True,
    )
    _create_index_if_not_exists(
        "idx_conversation_org_id", "conversation", ["org_id"], unique=False
    )
    _create_index_if_not_exists(
        "idx_conversation_participant_one",
        "conversation",
        ["participant_one_id"],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_conversation_participant_two",
        "conversation",
        ["participant_two_id"],
        unique=False,
    )
    ...
    if not _table_exists("message"):
        op.create_table(
            ...
            sa.Column(
                "message_uuid", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            ...
            sa.Column(
                "message_type", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            ...
            sa.ForeignKeyConstraint(
                ["reply_to_message_id"], ["message.id"], ondelete="SET NULL"
            ),
            sa.ForeignKeyConstraint(["sender_id"], ["user.id"], ondelete="CASCADE"),
            sa.PrimaryKeyConstraint("id"),
        )
    _create_index_if_not_exists(
        "ix_message_message_uuid", "message", ["message_uuid"], unique=True
    )
    _create_index_if_not_exists(
    ...
    _create_index_if_not_exists(
        "idx_message_sender", "message", ["sender_id"], unique=False
    )
    _create_index_if_not_exists(
        "idx_message_receiver", "message", ["receiver_id"], unique=False
    )
    _create_index_if_not_exists(
        "idx_message_created_at", "message", [sa.text("created_at DESC")], unique=False
    )
    _create_index_if_not_exists(
        "idx_message_type", "message", ["message_type"], unique=False
    )
    _create_index_if_not_exists(
        "idx_message_deleted", "message", ["is_deleted"], unique=False
    )
    ...
    if not _table_exists("message_edit_history"):
        op.create_table(
            ...
            sa.Column(
                "previous_content", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column("edited_by_user_id", sa.Integer(), nullable=False),
            sa.Column("edited_at", sa.DateTime(), nullable=False),
            sa.ForeignKeyConstraint(
                ["edited_by_user_id"], ["user.id"], ondelete="CASCADE"
            ),
            sa.ForeignKeyConstraint(["message_id"], ["message.id"], ondelete="CASCADE"),
            sa.PrimaryKeyConstraint("id"),
        )
    _create_index_if_not_exists(
        "idx_message_edit_history_message",
        "message_edit_history",
        ["message_id", sa.text("edited_at DESC")],
        unique=False,
    )
    ...
    if not _table_exists("message_attachment"):
        op.create_table(
            ...
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column(
                "attachment_uuid", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column("message_id", sa.BigInteger(), nullable=False),
            ...
            sa.Column(
                "thumbnail_url", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
            sa.Column(
                "upload_status", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
    ...
    _create_index_if_not_exists(
        "ix_message_attachment_attachment_uuid",
        "message_attachment",
        ["attachment_uuid"],
        unique=True,
    )
    ...
    _create_index_if_not_exists(
        "idx_message_attachment_type", "message_attachment", ["file_type"], unique=False
    )
    ...
    _create_index_if_not_exists(
        "idx_message_read_receipt_message",
        "message_read_receipt",
        ["message_id"],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_message_read_receipt_user",
        "message_read_receipt",
        ["user_id"],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_message_read_receipt_read_at",
        "message_read_receipt",
        ["read_at"],
        unique=False,
    ...
    if not _table_exists("conversation_participant_state"):
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["last_read_message_id"], ["message.id"], ondelete="SET NULL"
            ),
            sa.ForeignKeyConstraint(["user_id"], ["user.id"], ondelete="CASCADE"),
            sa.PrimaryKeyConstraint("id"),
            sa.UniqueConstraint(
                "conversation_id", "user_id", name="unique_participant_state"
            ),
        )
    _create_index_if_not_exists(
        "idx_participant_state_conversation",
        "conversation_participant_state",
        ["conversation_id"],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_participant_state_user",
        "conversation_participant_state",
        ["user_id"],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_participant_state_typing",
        "conversation_participant_state",
        ["is_typing", "typing_updated_at"],
        unique=False,
    )
    ...
    _create_index_if_not_exists(
        "ix_chat_notification_notification_uuid",
        "chat_notification",
        ["notification_uuid"],
        unique=True,
    )
    _create_index_if_not_exists(
        "idx_chat_notification_user",
        "chat_notification",
        ["user_id", "is_read", sa.text("created_at DESC")],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_chat_notification_message",
        "chat_notification",
        ["message_id"],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_chat_notification_type",
        "chat_notification",
        ["notification_type"],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_chat_notification_unread",
        "chat_notification",
        ["user_id", "is_read"],
        unique=False,
    ...
    _create_index_if_not_exists(
        "ix_chat_audit_log_log_uuid", "chat_audit_log", ["log_uuid"], unique=True
    )
    _create_index_if_not_exists(
        "idx_chat_audit_log_org",
        "chat_audit_log",
        ["org_id", sa.text("created_at DESC")],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_chat_audit_log_user",
        "chat_audit_log",
        ["user_id", sa.text("created_at DESC")],
        unique=False,
    )
    _create_index_if_not_exists(
        "idx_chat_audit_log_action", "chat_audit_log", ["action"], unique=False
    )
    _create_index_if_not_exists(
        "idx_chat_audit_log_resource",
        "chat_audit_log",
