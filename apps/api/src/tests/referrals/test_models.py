...
class TestReferralCodeBase:
    ...
    def test_default_status_is_active(self):
        ...
        code_base = ReferralCodeBase(
            code="TEST123ABC", referral_link="http://localhost:3000/ref/TEST123ABC"
        )
        assert code_base.status == ReferralCodeStatus.ACTIVE
    ...
    def test_code_max_length(self):
        ...
        long_code = "A" * 50
        code_base = ReferralCodeBase(
            code=long_code, referral_link="http://localhost:3000/ref/" + long_code
        )
    ...
    def test_referral_link_max_length(self):
        ...
        code_base = ReferralCodeBase(
            code="TEST", referral_link="http://localhost:3000/ref/TEST"
        )
