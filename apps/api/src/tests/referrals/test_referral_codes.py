...
class TestCreateReferralCodeForUser:
    ...
    async def test_create_new_code(self):
        ...
        mock_session.exec.return_value.first.side_effect = [None, None, Mock(spec=User, id=500, has_referral_code=False)]
    ...
    async def test_max_attempts_exceeded_raises_500(self):
        ...
        collision_mock = Mock()
        mock_session.exec.return_value.first.side_effect = [None] + [collision_mock] * (REFERRAL_CODE_MAX_ATTEMPTS + 1)
