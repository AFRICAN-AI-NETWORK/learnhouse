...
class TestReferralE2EFlow:
    ...
    async def test_complete_successful_referral_flow(self):
        ...
        with patch('src.services.referrals.referral_codes.generate_unique_code', return_value="REF123"):
...
class TestEdgeCases:
    ...
    async def test_large_batch_update(self):
        ...
        mock_session.exec.return_value.first.side_effect = [get_user(None) for _ in range(10)]
