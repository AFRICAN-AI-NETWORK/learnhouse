...
class TestWaitlistAuthenticationFlow:
    ...
    @pytest.mark.asyncio
    async def test_waitlist_user_cannot_login(self, db_session, sample_org, sample_waitlist_config, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_waitlist_activated_user_transitions_to_active(self, db_session, sample_org, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_suspended_user_cannot_login(self, db_session, sample_org, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_unverified_email_cannot_login(self, db_session, sample_org, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_waitlist_error_includes_launch_date(self, db_session, sample_org, 
                                                       sample_waitlist_config, mock_request):
        ...
        assert (sample_waitlist_config.name in error_message or 
                "waitlist" in error_message.lower())
...
class TestUserStatusTransitions:
    ...
    @pytest.mark.asyncio
    async def test_multiple_activated_logins_stay_active(self, db_session, sample_org, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_user_without_status_field_defaults_to_active(self, db_session, sample_org, mock_request):
...
class TestWaitlistErrorMessages:
    ...
    @pytest.mark.asyncio
    async def test_waitlist_message_without_config(self, db_session, sample_org, mock_request):
