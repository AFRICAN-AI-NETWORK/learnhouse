...
class EEAuditLogMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        path_query_data = {
            ...
            or request.query_params.get("orgId"),
            "org_slug": request.query_params.get("org_slug")
            or request.query_params.get("orgslug"),
            "course_id": request.query_params.get("course_id")
            or request.query_params.get("courseId"),
            "chapter_id": request.query_params.get("chapter_id")
            or request.query_params.get("chapterId"),
            "assignment_id": request.query_params.get("assignment_id")
            or request.query_params.get("assignmentId"),
            "certification_id": request.query_params.get("certification_id")
            or request.query_params.get("certificationId"),
        }
        ...
        user_id = None
        if hasattr(request.state, "user") and isinstance(
