...
const validate = (values: any, t: any) => {
  ...
  if (values.enable_certification && !values.certification_name) {
    errors.certification_name = t(
      'dashboard.courses.certification.form.certification_name_required'
    )
  } else if (
    values.certification_name &&
    values.certification_name.length > 100
  ) {
    errors.certification_name = t(
      'dashboard.courses.certification.form.certification_name_max_length'
    )
  }

  if (values.enable_certification && !values.certification_description) {
    errors.certification_description = t(
      'dashboard.courses.certification.form.certification_description_required'
    )
  } else if (
    values.certification_description &&
    values.certification_description.length > 500
  ) {
    errors.certification_description = t(
      'dashboard.courses.certification.form.certification_description_max_length'
    )
  }
...
function EditCourseCertification(props: EditCourseCertificationProps) {
  ...
  const {
    ...
    courseStructure?.course_uuid && access_token
      ? `certifications/course/${courseStructure.course_uuid}`
      : null,
    async () => {
                  ...
                  <Form.Root className="space-y-6">
                    ...
                    <div className="flex flex-col bg-gray-50 -space-y-1 px-3 sm:px-5 py-3 rounded-md mb-3">
                      <h3 className="font-bold text-md text-gray-800 flex items-center gap-2">
                        <FileText size={16} />
                        {t(
                          'dashboard.courses.certification.sections.basic_info.title'
                        )}
                      </h3>
                      <p className="text-gray-500 text-xs sm:text-sm">
                        {t(
                          'dashboard.courses.certification.sections.basic_info.subtitle'
                        )}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <FormField name="certification_type">
                        <FormLabelAndMessage
                          label={t(
                            'dashboard.courses.certification.form.certification_type_label'
                          )}
                        />
                        <Form.Control asChild>
                          <CustomSelect
                          ...
                          >
                            ...
                            <CustomSelectContent>
                              <CustomSelectItem value="completion">
                                {t(
                                  'dashboard.courses.certification.types.completion'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="achievement">
                                {t(
                                  'dashboard.courses.certification.types.achievement'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="assessment">
                                {t(
                                  'dashboard.courses.certification.types.assessment'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="participation">
                                {t(
                                  'dashboard.courses.certification.types.participation'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="mastery">
                                {t(
                                  'dashboard.courses.certification.types.mastery'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="professional">
                                {t(
                                  'dashboard.courses.certification.types.professional'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="continuing">
                                {t(
                                  'dashboard.courses.certification.types.continuing'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="workshop">
                                {t(
                                  'dashboard.courses.certification.types.workshop'
                                )}
                              </CustomSelectItem>
                              <CustomSelectItem value="specialization">
                                {t(
                                  'dashboard.courses.certification.types.specialization'
                                )}
                              </CustomSelectItem>
                            </CustomSelectContent>
                          </CustomSelect>
                    ...
                    <div className="flex flex-col bg-gray-50 -space-y-1 px-3 sm:px-5 py-3 rounded-md mb-3">
                      <h3 className="font-bold text-md text-gray-800 flex items-center gap-2">
                        <Award size={16} />
                        {t(
                          'dashboard.courses.certification.sections.certificate_design.title'
                        )}
                      </h3>
                      <p className="text-gray-500 text-xs sm:text-sm">
                        {t(
                          'dashboard.courses.certification.sections.certificate_design.subtitle'
                        )}
                      </p>
                    </div>
                  ...
                  <div className="bg-white rounded-xl shadow-xs border border-gray-200 sticky top-6 min-h-[320px]">
                    <div className="flex flex-col bg-gray-50 -space-y-1 px-3 sm:px-5 py-3 rounded-t-xl mb-3">
                      <h3 className="font-bold text-md text-gray-800 flex items-center gap-2">
                        <Award size={16} />
                        {t(
                          'dashboard.courses.certification.sections.preview.title'
                        )}
                      </h3>
                      <p className="text-gray-500 text-xs sm:text-sm">
                        {t(
                          'dashboard.courses.certification.sections.preview.subtitle'
                        )}
                      </p>
                    </div>
            ...
            {!formik.values.enable_certification && (
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                ...
                <h3 className="font-medium text-gray-700 mb-2">
                  {t('dashboard.courses.certification.states.disabled.title')}
                </h3>
                ...
                >
                  ...
                  {isCreating
                    ? t(
                        'dashboard.courses.certification.states.disabled.creating'
                      )
                    : t(
                        'dashboard.courses.certification.states.disabled.button'
                      )}
                </button>
              </div>
            )}
              ...
              isCreating && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
                  ...
                  <h3 className="font-medium text-blue-700 mb-2">
                    {t('dashboard.courses.certification.states.creating.title')}
                  </h3>
                  <p className="text-sm text-blue-600">
                    {t(
                      'dashboard.courses.certification.states.creating.message'
                    )}
                  </p>
                </div>
              )}
