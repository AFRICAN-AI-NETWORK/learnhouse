...
const SECTION_TYPES = {
  'image-gallery': {
    ...
    descriptionKey:
      'user.settings.profile_builder.section_types.image_gallery.description',
  },
  text: {
    icon: TextIcon,
    labelKey: 'user.settings.profile_builder.section_types.text.label',
    descriptionKey:
      'user.settings.profile_builder.section_types.text.description',
  },
  links: {
    icon: LinkIcon,
    labelKey: 'user.settings.profile_builder.section_types.links.label',
    descriptionKey:
      'user.settings.profile_builder.section_types.links.description',
  },
  skills: {
    icon: Award,
    labelKey: 'user.settings.profile_builder.section_types.skills.label',
    descriptionKey:
      'user.settings.profile_builder.section_types.skills.description',
  },
  experience: {
    icon: Briefcase,
    labelKey: 'user.settings.profile_builder.section_types.experience.label',
    descriptionKey:
      'user.settings.profile_builder.section_types.experience.description',
  },
  education: {
    icon: GraduationCap,
    labelKey: 'user.settings.profile_builder.section_types.education.label',
    descriptionKey:
      'user.settings.profile_builder.section_types.education.description',
  },
  affiliation: {
    icon: MapPin,
    labelKey: 'user.settings.profile_builder.section_types.affiliation.label',
    descriptionKey:
      'user.settings.profile_builder.section_types.affiliation.description',
  },
  courses: {
    icon: BookOpen,
    labelKey: 'user.settings.profile_builder.section_types.courses.label',
    descriptionKey:
      'user.settings.profile_builder.section_types.courses.description',
  },
} as const
...
const UserProfileBuilder = () => {
  ...
  const handleSave = async () => {
    ...
    const loadingToast = toast.loading(
      t('user.settings.profile_builder.saving')
    )
    ...
    try {
      ...
      if (res.status === 200) {
        toast.success(t('user.settings.profile_builder.toasts.save_success'), {
          id: loadingToast,
        })
      } else {
      ...
      toast.error(t('user.settings.profile_builder.toasts.save_error'), {
        id: loadingToast,
      })
    } finally {
      setIsSaving(false)
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between border-b pb-4">
          <div>
            <h2 className="text-xl font-semibold flex items-center">
              ...
              <div className="text-xs ml-2 bg-gray-200 text-gray-700 px-2 py-1 rounded-full">
                {t('user.settings.profile_builder.beta')}
              </div>
            </h2>
            <p className="text-gray-600">
              {t('user.settings.profile_builder.subtitle')}
            </p>
          </div>
          <Button
            variant="default"
          ...
          >
            {isSaving
              ? t('user.settings.profile_builder.saving')
              : t('user.settings.profile_builder.save_changes')}
          </Button>
        </div>
              ...
              >
                ...
                <SelectContent>
                  {Object.entries(SECTION_TYPES).map(
                    ([type, { icon: Icon, labelKey, descriptionKey }]) => (
    ...
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.image_gallery.title')}
        </h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label htmlFor="title">
            {t('user.settings.profile_builder.editors.section_title')}
          </Label>
          <Input
            id="title"
            value={section.title}
            ...
            placeholder={t(
              'user.settings.profile_builder.editors.enter_section_title'
            )}
          />
        </div>
        ...
        <div>
          <Label>
            {t('user.settings.profile_builder.editors.image_gallery.images')}
          </Label>
          <div className="space-y-3 mt-2">
            {section.images.map((image, index) => (
              ...
              >
                <div>
                  <Label>
                    {t(
                      'user.settings.profile_builder.editors.image_gallery.image_url'
                    )}
                  </Label>
                  <Input
                    value={image.url}
                    ...
                    placeholder={t(
                      'user.settings.profile_builder.editors.image_gallery.enter_image_url'
                    )}
                  />
                </div>
                <div>
                  <Label>
                    {t(
                      'user.settings.profile_builder.editors.image_gallery.caption'
                    )}
                  </Label>
                  <Input
                    value={image.caption || ''}
                    ...
                    placeholder={t(
                      'user.settings.profile_builder.editors.image_gallery.image_caption'
                    )}
                  />
                </div>
            ...
            >
              <Plus className="h-4 w-4 mr-2" />
              {t(
                'user.settings.profile_builder.editors.image_gallery.add_image'
              )}
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.text.title')}
        </h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label htmlFor="content">
            {t('user.settings.profile_builder.editors.text.content')}
          </Label>
          <Textarea
            id="content"
            ...
            placeholder={t(
              'user.settings.profile_builder.editors.text.enter_content'
            )}
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.links.title')}
        </h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label>
            {t('user.settings.profile_builder.editors.links.links')}
          </Label>
          <div className="space-y-3 mt-2">
            {section.links.map((link, index) => (
              ...
              >
                <Input
                  ...
                  placeholder={t(
                    'user.settings.profile_builder.editors.links.link_title'
                  )}
                />
                <Input
                  value={link.url}
                  ...
                  placeholder={t(
                    'user.settings.profile_builder.editors.links.url'
                  )}
                />
                <Button
                  variant="ghost"
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.skills.title')}
        </h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label>
            {t('user.settings.profile_builder.editors.skills.skills')}
          </Label>
          <div className="space-y-3 mt-2">
            {section.skills.map((skill, index) => (
              ...
              >
                <Input
                  ...
                  placeholder={t(
                    'user.settings.profile_builder.editors.skills.skill_name'
                  )}
                />
                <Select
                ...
                >
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t(
                        'user.settings.profile_builder.editors.skills.select_level'
                      )}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="beginner">
                      {t(
                        'user.settings.profile_builder.editors.skills.levels.beginner'
                      )}
                    </SelectItem>
                    <SelectItem value="intermediate">
                      {t(
                        'user.settings.profile_builder.editors.skills.levels.intermediate'
                      )}
                    </SelectItem>
                    <SelectItem value="advanced">
                      {t(
                        'user.settings.profile_builder.editors.skills.levels.advanced'
                      )}
                    </SelectItem>
                    <SelectItem value="expert">
                      {t(
                        'user.settings.profile_builder.editors.skills.levels.expert'
                      )}
                    </SelectItem>
                  </SelectContent>
                </Select>
                <Input
                  ...
                  placeholder={t(
                    'user.settings.profile_builder.editors.skills.category'
                  )}
                />
                <Button
                  variant="ghost"
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.experience.title')}
        </h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label>
            {t('user.settings.profile_builder.editors.experience.items')}
          </Label>
          <div className="space-y-4 mt-2">
              ...
              <div key={index} className="space-y-4 p-4 border rounded-lg">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.experience.role_title'
                      )}
                    </Label>
                    <Input
                      ...
                      placeholder={t(
                        'user.settings.profile_builder.editors.experience.role_placeholder'
                      )}
                    />
                  </div>
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.experience.organization'
                      )}
                    </Label>
                    <Input
                      ...
                      placeholder={t(
                        'user.settings.profile_builder.editors.experience.organization_placeholder'
                      )}
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr_1fr_auto] gap-4">
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.experience.start_date'
                      )}
                    </Label>
                    <Input
                      type="date"
                  ...
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.experience.end_date'
                      )}
                    </Label>
                    <Input
                      type="date"
                  ...
                  <div className="flex items-end">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor={`current-${index}`}>
                        {t(
                          'user.settings.profile_builder.editors.experience.current'
                        )}
                      </Label>
                    </div>
                  </div>
                ...
                <div>
                  <Label>
                    {t(
                      'user.settings.profile_builder.editors.experience.description'
                    )}
                  </Label>
                  <Textarea
                    ...
                    placeholder={t(
                      'user.settings.profile_builder.editors.experience.description_placeholder'
                    )}
            ...
            >
              <Plus className="h-4 w-4 mr-2" />
              {t(
                'user.settings.profile_builder.editors.experience.add_experience'
              )}
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.education.title')}
        </h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label>
            {t('user.settings.profile_builder.editors.education.items')}
          </Label>
          <div className="space-y-4 mt-2">
              ...
              <div key={index} className="space-y-4 p-4 border rounded-lg">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.education.institution'
                      )}
                    </Label>
                    <Input
                      ...
                      placeholder={t(
                        'user.settings.profile_builder.editors.education.institution_placeholder'
                      )}
                    />
                  </div>
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.education.degree'
                      )}
                    </Label>
                    <Input
                      value={edu.degree}
                      ...
                      placeholder={t(
                        'user.settings.profile_builder.editors.education.degree_placeholder'
                      )}
                    />
                  </div>
                </div>
                ...
                <div>
                  <Label>
                    {t('user.settings.profile_builder.editors.education.field')}
                  </Label>
                  <Input
                    value={edu.field}
                    onChange={(e) => {
                    ...
                    placeholder={t(
                      'user.settings.profile_builder.editors.education.field_placeholder'
                    )}
                  />
                </div>
                ...
                <div className="grid grid-cols-[1fr_1fr_auto] gap-4">
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.education.start_date'
                      )}
                    </Label>
                    <Input
                      type="date"
                  ...
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.education.end_date'
                      )}
                    </Label>
                    <Input
                      type="date"
                  ...
                  <div className="flex items-end">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor={`current-edu-${index}`}>
                        {t(
                          'user.settings.profile_builder.editors.education.current'
                        )}
                      </Label>
                    </div>
                  </div>
                ...
                <div>
                  <Label>
                    {t(
                      'user.settings.profile_builder.editors.education.description'
                    )}
                  </Label>
                  <Textarea
                    ...
                    placeholder={t(
                      'user.settings.profile_builder.editors.education.description_placeholder'
                    )}
            ...
            >
              <Plus className="h-4 w-4 mr-2" />
              {t(
                'user.settings.profile_builder.editors.education.add_education'
              )}
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.affiliation.title')}
        </h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label>
            {t(
              'user.settings.profile_builder.editors.affiliation.affiliations'
            )}
          </Label>
          <div className="space-y-3 mt-2">
              ...
              <div key={index} className="space-y-4 p-4 border rounded-lg">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.affiliation.name'
                      )}
                    </Label>
                    <Input
                      ...
                      placeholder={t(
                        'user.settings.profile_builder.editors.affiliation.name_placeholder'
                      )}
                    />
                  </div>
                  <div>
                    <Label>
                      {t(
                        'user.settings.profile_builder.editors.affiliation.logo_url'
                      )}
                    </Label>
                    <Input
                      ...
                      placeholder={t(
                        'user.settings.profile_builder.editors.affiliation.logo_url_placeholder'
                      )}
                    />
                  </div>
                </div>
                ...
                <div>
                  <Label>
                    {t(
                      'user.settings.profile_builder.editors.affiliation.description'
                    )}
                  </Label>
                  <Textarea
                    ...
                    placeholder={t(
                      'user.settings.profile_builder.editors.affiliation.description_placeholder'
                    )}
                    className="min-h-[100px]"
                  />
                </div>
            ...
            >
              <Plus className="h-4 w-4 mr-2" />
              {t(
                'user.settings.profile_builder.editors.affiliation.add_affiliation'
              )}
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg nice-shadow">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="font-medium text-lg">
          {t('user.settings.profile_builder.editors.courses.title')}
        </h3>
      </div>
