    ...
    try {
      ...
      certificateDiv.innerHTML = `
        ...
        ">
          ...
          <span>${
            ...
            'completion'
              ...
              : userCertificate.certification.config.certification_type ===
                  'achievement'
                ? t('certificate.achievement_based')
                : userCertificate.certification.config.certification_type ===
                    'assessment'
                  ? t('certificate.assessment_based')
                  : userCertificate.certification.config.certification_type ===
                      'participation'
                    ? t('certificate.participation')
                    : userCertificate.certification.config
                          .certification_type === 'mastery'
                      ? t('certificate.skill_mastery')
                      : userCertificate.certification.config
                            .certification_type === 'professional'
                        ? t('certificate.professional_development')
                        : userCertificate.certification.config
                              .certification_type === 'continuing'
                          ? t('certificate.continuing_education')
                          : userCertificate.certification.config
                                .certification_type === 'workshop'
                            ? t('certificate.workshop_attendance')
                            : userCertificate.certification.config
                                  .certification_type === 'specialization'
                              ? t('certificate.specialization')
                              : t('courses.course_completion')
          }</span>
        </div>
        ...
        ">
          ...
          <div style="margin: 8px 0; font-size: 14px; color: #374151;">
            <strong style="color: ${theme.primary};">${t('certificate.awarded')}:</strong> ${new Date(
