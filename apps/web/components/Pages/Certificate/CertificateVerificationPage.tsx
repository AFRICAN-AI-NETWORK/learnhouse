        ...
        <div className="bg-white rounded-2xl p-8 nice-shadow max-w-2xl w-full space-y-6">
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 w-full">
              <p className="text-red-800 text-sm">This could mean:</p>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl p-6 mb-8 nice-shadow">
          <div className="flex items-center justify-between">
            ...
            <div
              className={`flex items-center space-x-3 px-4 py-2 rounded-full border ${getVerificationStatusColor()}`}
            >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 nice-shadow">
              ...
              <div className="max-w-2xl mx-auto" id="certificate-preview">
                <CertificatePreview
                  certificationName={
                    certificateData.certification.config.certification_name
                  }
                  ...
                  certificatePattern={
                    certificateData.certification.config.certificate_pattern
                  }
                ...
                <div className="flex-1 min-w-0">
                  <div className="space-y-1">
                    ...
                    {certificateData.course.authors &&
                      certificateData.course.authors.length > 0 && (
                        <div className="flex items-center space-x-1 text-sm text-neutral-400 font-normal">
                          ...
                          <div className="flex items-center space-x-1">
                            {certificateData.course.authors
                              .filter(
                                (author: any) =>
                                  author.authorship_status === 'ACTIVE'
                              )
                              .slice(0, 2)
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <span className="text-gray-900 capitalize">
                      {certificateData.certification.config.certification_type.replace(
                        '_',
                        ' '
                      )}
                    </span>
