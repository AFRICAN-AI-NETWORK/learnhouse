        ...
        <div className="max-w-5xl mx-auto pt-[80px] md:pt-[100px] pb-8 px-4 md:px-2">
          ...
          <div className="md:hidden mb-6">
            <button
              ...
              className="w-full flex items-center justify-between border border-zinc-300 dark:border-white/8 rounded-lg px-4 py-3 text-sm bg-white dark:bg-[#13131a] dark:text-white/80"
            >
          ...
          {isOpen && (
            <div className="fixed inset-0 z-50 flex">
              ...
              {/* Drawer */}
              <div className="relative w-72 bg-white dark:bg-[#13131a] h-full p-6 overflow-y-auto shadow-xl dark:border-r dark:border-white/8">
