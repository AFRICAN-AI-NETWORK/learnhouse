...
export default function LaravelBackendPage() {
  const org = useOrg() as any
  const [expandedModule, setExpandedModule] = useState<number | null>(null)
  const [isSubscription, setIsSubscription] = useState(true)

  const courseId = 'laravel-backend-uuid' // Placeholder
  ...
  const modules = [
    ...
    {
      num: 3,
      title: 'Production Ready (Month 3)',
      details: [
  ...
  const audienceGroups = [
    {
      label: 'PHP Developers upgrading to Laravel',
      color: 'bg-rose-50 text-rose-700',
    },
    { label: 'Aspiring Backend Engineers', color: 'bg-blue-50 text-blue-700' },
    {
      label: 'Frontend Devs going Fullstack',
      color: 'bg-emerald-50 text-emerald-700',
    },
    { label: 'University Students', color: 'bg-purple-50 text-purple-700' },
  ]

  return (
    <div
      className="min-h-screen bg-white text-[#0a0f1e] selection:bg-rose-500/20"
    ...
    >
      ...
      <section className="relative pt-36 pb-28 px-6 lg:px-12 bg-[#0a0f1e] overflow-hidden">
        ...
        />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-rose-500/15 blur-[150px] rounded-full pointer-events-none" />

        <div className="relative z-10 max-w-5xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="flex-1 space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-500/20 text-rose-400 text-xs font-bold uppercase tracking-widest border border-rose-500/30">
              ...
              <h1 className="text-4xl md:text-[56px] font-black text-white leading-[1.08] tracking-tight uppercase">
                Backend Development
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-red-500 mt-1">
                  Laravel Edition
                </span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed max-w-xl">
                Become a highly sought-after PHP developer in 3 months. Learn
                Laravel, relational database design, authentication, APIs, and
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <span className="text-sm text-gray-500 flex items-center gap-1.5">
                  <Code size={16} className="text-gray-400" /> PHP/Laravel
                </span>
              </div>
              <div className="pt-4">
                <Link
                  href="#curriculum"
                  className="inline-flex items-center gap-3 bg-rose-500 hover:bg-rose-600 text-white px-8 py-4 rounded-xl font-bold text-[15px] transition-all hover:scale-105 shadow-[0_0_40px_-10px_rgba(244,63,94,0.5)]"
                >
              ...
              <div className="bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-[24px] p-8 space-y-6">
                <div>
                  ...
                  <div className="mt-8 space-y-4">
                    <span className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-rose-500/20 text-rose-400 text-xs font-bold uppercase tracking-wider w-max">
      ...
      <section className="py-20 px-6 lg:px-12 bg-[#f9fafb] border-b border-gray-100">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
          {[
            { word: 'Build', sub: 'Robust RESTful APIs & MVC apps.' },
            { word: 'Scale', sub: 'Master caching, queues & optimization.' },
            { word: 'Deploy', sub: 'CI/CD, Docker & Linux servers.' },
          ].map((p, i) => (
            <motion.div
              key={i}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12 mb-16 items-end">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-500/10 text-rose-500 text-xs font-bold uppercase tracking-widest mb-4">
                What You&apos;ll Learn
              </div>
              <h2 className="text-3xl md:text-5xl font-bold text-[#0a0f1e] leading-tight uppercase">
                From beginner to{' '}
                <span className="text-rose-500">
                  job-ready Laravel developer.
                </span>
              </h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              'Master PHP 8 Object-Oriented Programming and MVC architecture',
              'Build secure authentication systems with JWT, OAuth, and RBAC',
              'Design relational databases and interact using Eloquent ORM',
              'Develop scalable RESTful APIs with Swagger documentation',
              'Implement queues, jobs, and events for background processing',
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-[#0a0f1e] uppercase">
              3 Phases. <span className="text-rose-500">Zero to Hero.</span>
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {modules.map((mod) => (
              ...
              >
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-rose-100 flex items-center justify-center text-rose-600 font-black text-lg">
                    {mod.num}
                  </div>
                    ...
                    <ul className="space-y-3 mt-6">
                      {mod.details.map((detail, i) => (
                        <li key={i} className="flex items-start gap-3">
                          <span className="text-rose-600 mt-0.5 flex-shrink-0">
                            →
                          </span>
      ...
      <section className="relative py-32 px-6 overflow-hidden bg-white">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-gradient-to-r from-rose-500/20 to-red-400/10 blur-[120px] rounded-full" />
        </div>
        <div className="relative max-w-4xl mx-auto bg-[#0a0f1e] rounded-[40px] p-12 md:p-20 text-center shadow-[0_20px_40px_-15px_rgba(244,63,94,0.4)] overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-white text-xs font-bold uppercase tracking-widest border border-white/20 backdrop-blur-md">
              <Database size={14} className="text-rose-400" /> Start Building
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link
                href="/auth/signup"
                className="w-full sm:w-auto px-10 py-5 bg-rose-500 text-white rounded-xl font-bold text-[15px] hover:bg-rose-600 transition-all hover:scale-105 shadow-[0_0_40px_-10px_rgba(244,63,94,0.5)] flex items-center justify-center gap-3"
              >
