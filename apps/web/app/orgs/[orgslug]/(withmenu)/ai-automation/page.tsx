      ...
      <section className="py-24 px-6 lg:px-12 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-[#0a0f1e] mb-8 uppercase">
            ...
            <span className="text-purple-600">underpriced.</span>
          </h2>
        ...
        <div className="relative max-w-4xl mx-auto bg-[#0a0f1e] rounded-[40px] p-12 md:p-20 text-center shadow-[0_20px_40px_-15px_rgba(147,51,234,0.4)] overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
              No code. Real business results. From manual tasks to automating
              real businesses at <PriceDisplay basePriceUSD={37} interval="/month" hideSwitcher className="inline-flex items-center text-purple-400 ml-1" priceClassName="text-[inherit]" />.
            </p>
