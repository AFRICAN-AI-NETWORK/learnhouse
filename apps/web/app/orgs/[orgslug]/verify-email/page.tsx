...
function VerifyEmailContent({ params }: { params: Promise<{ orgslug: string }> }) {
    ...
    useEffect(() => {
        ...
        const org = searchParams.get('orgslug') || orgslug || 'default';
...
export default function VerifyEmailPage({ params }: { params: Promise<{ orgslug: string }> }) {
    return (
        <Suspense fallback={
